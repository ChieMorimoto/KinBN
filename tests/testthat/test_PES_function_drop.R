...
test_that("PES_function_drop",{
  ...
  sibling.alleletype[,,1,] <- matrix(c(16,NA,17,17,9,9,12,12,8,12,15,15,30,30,13,15,10,14,
  ...
  expect_equal(round(PES_function_drop(sibling.data, 2, 1, 0.1, 1, 0.001, 1:21),digits=3),
               round(matrix(c( 2.066409, 1.149297, 26.76072, 0.9482825, 0.4930989, 0.25,
                               1.168352, 1.281964, 3.965235, 0.9647277, 9.077448, 1.196464,
                               0.6416346, 1.868048, 5.849857, 8.80006, 2.083542, 3.533881,
                               0.25, 8.09918, 2.64288),1,21),digits=3))
})
