...
test_that("PES_function",{
  ...
  expect_equal(round(PES_function(sibling.data, 1, 0.001, 1:21),digits=3),
               round(matrix(c( 1.319394, 1.149297, 26.76072, 0.9482825, 0.4930989, 0.25,
