KinBN <- function(ped.max = 25, range = 0){
  ...
  if(requireNamespace("graph")){
    ...
    BiocManager::install(c("graph"),update=F)
    if(requireNamespace("graph")){
  ...
  if(requireNamespace("Rgraphviz")){
    print("Rgraphviz is loaded correctly")
  }
  else{
    print("trying to install Rgraphviz...")
    BiocManager::install(c("Rgraphviz"),update=F)
    if(requireNamespace("Rgraphviz")){
      print("Rgraphviz installed and loaded")
    }
    else{
      stop("could not install Rgraphviz")
    }
  }
  ...
  #}
    ...
    packageurl <- "https://cran.r-project.org/src/contrib/Archive/tkRplotR/tkRplotR_0.1.1.tar.gz"
